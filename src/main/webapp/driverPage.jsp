  ...
  <div class="container-fluid">
	...
	<div class="h-100 px-5 py-5 bg-dark text-black rounded-xl">
		<div class="h-75 bg-white p-5" style="border-radius: 1rem">
			<h1>Welcome, Accept customers</h1><hr/>
			<%
				//String urole="User";
				...
				<thead class="thead-dark">
					...
					%>
						<tbody>
							...
							<td scope="row"><%=rs.getString("phone_no") %></td>
							<td scope="row"><%=rs.getString("pickup_location") %></td>
							<td scope="row"><%=rs.getString("drop_location") %></td>
							</tr>
						</tbody>
